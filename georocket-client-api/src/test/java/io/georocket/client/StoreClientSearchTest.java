...
public class StoreClientSearchTest extends StoreClientTestBase {
  ...
  public void exportRoot(TestContext context) {
    ...
    client.getStore().search(new SearchParams().setLayer("/"),
  ...
  public void exportLayer(TestContext context) {
    ...
    stubFor(get(urlEqualTo(url))
        .willReturn(aResponse()
            .withStatus(200)
            .withBody(XML)));
    client.getStore().search(new SearchParams().setLayer("/hello/world"),
  ...
  public void simpleQuery(TestContext context) {
    ...
    stubFor(get(urlEqualTo(url))
        .willReturn(aResponse()
            .withStatus(200)
            .withBody(XML)));
    client.getStore().search(new SearchParams().setQuery("test"),
        context.asyncAssertSuccess(assertExport(url, XML, context, context.async())));
  }
  ...
  public void twoTermsQuery(TestContext context) {
    ...
    stubFor(get(urlEqualTo(url))
        .willReturn(aResponse()
            .withStatus(200)
            .withBody(XML)));
    client.getStore().search(new SearchParams().setQuery("test1 test2"),
        context.asyncAssertSuccess(assertExport(url, XML, context, context.async())));
  }
  ...
  public void layer(TestContext context) {
    ...
    stubFor(get(urlEqualTo(url))
        .willReturn(aResponse()
            .withStatus(200)
            .withBody(XML)));
    client.getStore().search(new SearchParams().setQuery("test").setLayer("hello/world"),
        context.asyncAssertSuccess(assertExport(url, XML, context, context.async())));
  }
