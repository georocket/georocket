...
The default page size is 100. It can be changed by providing a pageSize query
argument with the initial pagination erquest. After the pegination has started, the
pageSize will have no effect on further requests.

===== Example request

  GET /store/CityModel?paginated=true&pageSize=75&search=LOD1+textured+13.378,52.515,13.380,52.517 HTTP/1.1
