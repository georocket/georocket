...
Linux:
  ...
  export PATH=/path/to/georocket-cli-1.1.1/bin:$PATH

Windows:

  set PATH=C:\path\to\georocket-cli-1.1.1\bin;%PATH%
====
...
| *georocket.http.compress* +
  _(default: true)_
| True if GeoRocket should compress responses with gzip/deflate if the client supports it.
|===
